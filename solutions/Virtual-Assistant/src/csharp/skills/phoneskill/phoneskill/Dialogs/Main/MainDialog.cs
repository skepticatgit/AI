...
using PhoneSkill.Dialogs.Sample;
...
namespace PhoneSkill.Dialogs.Main
{
    public class MainDialog : RouterDialog
    {
        ...
        protected override async Task RouteAsync(DialogContext dc, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            localeConfig.LuisServices.TryGetValue("PhoneSkill", out var luisService);
            ...
            else
            {
                ...
                var result = await luisService.RecognizeAsync<PhoneSkillLU>(dc.Context, CancellationToken.None);
                var intent = result?.TopIntent().intent;

                switch (intent)
                {
                    case PhoneSkillLU.Intent.Sample:
                        {
                            turnResult = await dc.BeginDialogAsync(nameof(SampleDialog), skillOptions);
                            break;
                        }

                    case PhoneSkillLU.Intent.None:
                        {
